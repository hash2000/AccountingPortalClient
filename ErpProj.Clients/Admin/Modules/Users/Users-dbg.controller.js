sap.ui.define([
    ...
    Controller, Core, mobileLibrary, MessageBox, ODataModel, JSONModel,
    Sorter, Filter, FilterOperator, FilterType) {
    "use strict";
    ...
    return Controller.extend("ErpProj.Modules.Users.Users", {
        ...
        onRefresh: function () {
            var oView = this.getView(),
                oBinding = oView.byId("ProfilesTable")
                    .getBinding("items");
            if (oBinding) {
